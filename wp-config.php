 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'authorization_key');
define('SECURE_AUTH_KEY',  'sec_authorization_key');
define('LOGGED_IN_KEY',    'log_in_key');
define('NONCE_KEY',        'non_key');
define('AUTH_SALT',        'authorization_salt');
define('SECURE_AUTH_SALT', 'sec_authorization_salt');
define('LOGGED_IN_SALT',   'log_in_salt');
define('NONCE_SALT',       'non_salt');
